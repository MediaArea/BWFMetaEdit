...
"<a href=\"http://www.digitizationguidelines.gov\">Federal Agencies Digitization Guidelines Initiative (FADGI)</a> BWF MetaEdit 1.2.0BETA2"
;}

//---------------------------------------------------------------------------
const char* NameVersion_Text() {return
"Federal Agencies Digitization Guidelines Initiative (FADGI)\n"
"BWF MetaEdit 1.2.0BETA2"
;}
...
column_text Columns[]=
{
    ...
    {"BextVersion", "(TODO) Use to express whether the Bext Chunk follows the Rules of EBU Technical document 3285 as published in 1997 (version '0') or the 2001 update which created version '1'.\nVersion '1' adds an additional field for UMID. Example '1'."},
    {"UMID", "UMID: Unique Material Identifier"},
    {"LoudnessValue", "(TODO)"},
    {"LoudnessRange", "(TODO)"},
    {"MaxTruePeakLevel", "(TODO)"},
    {"MaxMomentaryLoudness", "(TODO)"},
    {"MaxShortTermLoudness", "(TODO)"},
