...
const size_t Columns_Text_Size=18+9+17;
column_text Columns[]=
{
    ...
    {"BextVersion", "Use to express whether the Bext Chunk follows the Rules of EBU Technical document 3285 as published in 1997 (version '0') or the 2001 update which created version '1'.\nVersion '1' adds an additional field for UMID. Example '1'."},
