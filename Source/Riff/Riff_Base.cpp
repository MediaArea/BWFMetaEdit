...
//---------------------------------------------------------------------------
void Riff_Base::Encode (std::string& Str)
{
...
//---------------------------------------------------------------------------
void Riff_Base::Decode (std::string& Str)
{
    switch (Global->Encoding)
    {
        case Encoding_8859_1:
            Str.assign(Ztring().From_ISO_8859_1(Str.c_str()).To_UTF8());
        break;
        case Encoding_8859_2:
            Str.assign(Ztring().From_ISO_8859_2(Str.c_str()).To_UTF8());
        break;
        default:
            ;
    }
